            ...
            <div className="sm:flex items-center justify-between md:gap-8 ">
                ...
                <div className="w-full sm:w-1/2">
                    <p className="text-gray-300 leading-7 mt-4 sm:mt-0">
                         Let's Innovate Together: As a Full Stack Developer with expertise in both frontend and backend, I'm ready to bring your ideas to life. Connect with me now to discuss your project and embark on a journey of innovation
                    </p>
